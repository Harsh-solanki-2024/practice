...
--
-- Host: localhost    Database: online_mcq_system
-- ------------------------------------------------------
...
CREATE TABLE `exam` (
  ...
  `exam_passing_score` int DEFAULT NULL,
  `total_no_of_questions` int DEFAULT NULL,
  `exam_instructions_rules` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `exam_result` (
  ...
  `exam_feedback` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `questions` (
  ...
  `topic_of_question` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2024-04-02 18:14:12
