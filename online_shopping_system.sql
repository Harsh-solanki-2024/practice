...
CREATE TABLE `register` (
  ...
  PRIMARY KEY (`id`),
  KEY `role_id` (`role_id`),
  CONSTRAINT `register_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_carts` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `user_carts_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  CONSTRAINT `user_carts_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `register` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-04-02 18:17:09
